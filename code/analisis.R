...
hist(bd_games$price_final, main = "Distribución de Precios", xlab = "Precio", ylab = "Frecuencia")
hist(bd_games$price_original, main = "Distribución de Precios", xlab = "Precio original", ylab = "Frecuencia")
hist(bd_games$positive_ratio, main = "Distribución de Calificaciones", xlab = "Positive ratio", ylab = "Frecuencia")

boxplot(bd_games$price_final, main = "Diagrama de Cajas y Bigotes", ylab = "Precio")
boxplot(bd_games$positive_ratio, main = "Diagrama de Cajas y Bigotes", ylab = "Precio")
...
hist(bd_games_precios_bajos$price_final, main = "Distribución de Precios", xlab = "Precio", ylab = "Frecuencia")
hist(bd_games_precios_bajos$positive_ratio, main = "Distribución de Precios", xlab = "Precio", ylab = "Frecuencia")

boxplot(bd_games_precios_bajos$price_final, main = "Diagrama de Cajas y Bigotes", ylab = "Precio")
boxplot(bd_games_precios_bajos$positive_ratio, main = "Diagrama de Cajas y Bigotes", ylab = "Precio")
...
cat(paste("Para la columna positive_ratio:\n", 
